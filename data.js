// 本文件由内容编辑器同步生成（2026-09-11T02:30:49.781Z）
// 手动编辑请改下面的 SITE / GROUPS；图片文件需放在 photos/ 文件夹内。
const SITE = {
  "title": "Toneby LUT Showcase",
  "subtitle": "Explore the colors of Toneby."
};
    ...
    "luts": [
      {
        ...
        "desc": "经典日系胶片发色，柔和的低反差与清新肤色，适合日常、人像与旅拍。示例文案，可在编辑器里修改。",
        "images": [
          "covers/lut_icon_02.jpg",
          "covers/lut_icon_03.jpg",
    ...
    "luts": [
      {
        "name": "仿胶卷",
        "title": "仿胶卷——模拟胶片发色",
        "desc": "模拟传统胶片的发色与层次，示例文案，可在编辑器里修改。",
        "images": [
          "covers/lut_icon_05.jpg",
          "covers/lut_icon_06.jpg",
          "covers/lut_icon_01.jpg"
    ...
    "luts": [
      {
        ...
        "title": "CLASSIC FEATURE——经典正片风格",
        "desc": "经典正片（反转片）风格，示例文案，可在编辑器里修改。",
        "images": [
          "covers/lut_icon_10.jpg",
          "covers/lut_icon_11.jpg",
      ...
      },
      {
        ...
        "title": "CLASSIC NEGATIVE——经典负片风格",
        "desc": "经典彩色负片风格，示例文案，可在编辑器里修改。",
        "images": [
          "covers/lut_icon_11.jpg",
          "covers/lut_icon_10.jpg",
    ...
    "luts": [
      {
        "name": "BWL",
        "title": "BWL——黑白 L",
        "desc": "黑白调色 L 版本，示例文案，可在编辑器里修改。",
        "images": [
          "covers/lut_icon_16.jpg",
          "covers/lut_icon_17.jpg",
          "covers/lut_icon_19.jpg"
        ],
        "film": "",
        "note": "",
        "credits": []
      },
      {
        "name": "BWLL",
        "title": "BWLL——黑白 LL",
        "desc": "黑白调色 LL 版本，示例文案，可在编辑器里修改。",
        "images": [
          "covers/lut_icon_17.jpg",
          "covers/lut_icon_16.jpg",
          "covers/lut_icon_20.jpg"
        ],
        "film": "",
        "note": "",
        "credits": []
